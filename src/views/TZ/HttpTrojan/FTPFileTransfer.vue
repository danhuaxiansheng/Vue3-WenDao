...
export default {
        ...
        return {
            ...
            tabConfig: {
                ...
                options: {
                    ...
                    dataFlow: { isEnable: false, text: "会话分析" },
                }
            },
            gridOptions: {
    ...
    methods: {
        beforeReloadTable(conditions) {
            ...
            //需求：该页面默认查"威胁等级>疑"的数据
            conditions.push({
                conds: [
                    { field: "risklevel", op: "equal", value: "16", leftText: "(", rightText: "", connector: "or" },
                    { field: "risklevel", op: "equal", value: "21", leftText: "", rightText: ")", connector: "and" }
                ]
            });
        },
    },
